...
## 📌 Rule
1. 매주 이것이 코딩테스트이다. 챕터 기준 책에서 3문제 | 실버난이도 1 + 골드난이도 1 정도의 문제 풀이를 진행한다. 추가로 전주 주제의 실버,골드정도의 문제를 추가로 푼다. <br>
  분량 : [이번주 주제] 책(3문제) + 실버(1문제) + 골드(1문제) | [이전주 주제] 실버(1문제) + 골드(1문제)

*  스터디 일시 (화 수 목 中1 / 22:00 ~)
*  스터디 방식 
...
**이름/주차_주제/플랫폼_난이도_문제번호_문제이름/...**
  ...
  kimjingeun/1_Greedy/BJ_S4_12345_문제이름/...py
